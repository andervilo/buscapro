<?php namespace App\Http\Controllers;
	...
	class AdminServicoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			*/
			...
			#$this->form[] = ['label'=>'User Id','name'=>'user_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_users,name','datatable_where'=>'id='.CRUDBooster::myid()];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Usuário','name'=>'user_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_users,name','datatable_where'=>'id=1'];
			//$this->form[] = ['label'=>'Profissão','name'=>'profissao_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'profissao,profdesc'];
			//$this->form[] = ['label'=>'Especialidades','name'=>'especialidades','type'=>'select2','width'=>'col-sm-10','datatable'=>'especialidade,descricao','relationship_table'=>'servico_especialidade'];
			//$this->form[] = ['label'=>'Descrição','name'=>'descricao','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			# OLD END FORM
